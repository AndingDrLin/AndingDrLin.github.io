...
> 完整代码见 [`code/02-prompt-engineering/prompt_strategies.py`](./code/02-prompt-engineering/prompt_strategies.py)。
...
> 完整代码见 [`code/02-prompt-engineering/cot_reasoning.py`](./code/02-prompt-engineering/cot_reasoning.py)。
...
> 完整代码见 [`code/02-prompt-engineering/text_classifier.py`](./code/02-prompt-engineering/text_classifier.py)，其中包含一个用纯 Prompt 实现的文本分类器。
...
下一章：[RAG — 让 LLM 拥有外部知识](./03-rag.md)。
