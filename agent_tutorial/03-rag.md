...
> 完整代码见 [`code/03-rag/pdf_qa.py`](./code/03-rag/pdf_qa.py)。
...
> 完整代码见 [`code/03-rag/chunking_experiment.py`](./code/03-rag/chunking_experiment.py)。
...
> 完整代码见 [`code/03-rag/hybrid_search.py`](./code/03-rag/hybrid_search.py)。
...
下一章：[Tool Use — 让 LLM 调用外部工具](./04-tool-use.md)。
