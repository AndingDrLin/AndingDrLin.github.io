...
> 完整代码见 [`code/09-production/eval_pipeline.py`](./code/09-production/eval_pipeline.py)。
...
> 完整代码见 [`code/09-production/prompt_injection_demo.py`](./code/09-production/prompt_injection_demo.py)。
...
> 完整代码见 [`code/09-production/cost_monitoring.py`](./code/09-production/cost_monitoring.py)。
...
下一章：[毕业项目](./10-capstone.md) — 独立完成一个完整 Agent 产品。
