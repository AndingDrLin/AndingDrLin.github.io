...
> 代码骨架见 [`code/10-capstone/research_assistant/`](./code/10-capstone/research_assistant/)。
...
> 详见 [`code/10-capstone/code_qa/`](./code/10-capstone/code_qa/) 和 [`code/10-capstone/knowledge_base/`](./code/10-capstone/knowledge_base/) 目录。
