...
description: "Engineering Project Management & Finance 期末复习资料总目录与使用顺序。"
date: 2026-04-27
tags:
  - exam-revision
  - project-management
...
- [第0章 考试地图与题目索引](/notes/engineering-project-management-and-finance/00_exam_and_question_map/) — 样题题型与知识块总览，以及按 Sample Set / 题号反查到对应分册
- [第1章 DFM 与可持续设计](/notes/engineering-project-management-and-finance/01_dfm_sustainability/) — DFM、sustainability、4Rs
- [第2章 质量与 Six Sigma](/notes/engineering-project-management-and-finance/02_quality_six_sigma/) — QC/QA、7QC、control chart、Taguchi、Six Sigma、Cp/Cpk
- [第3章 项目管理基础](/notes/engineering-project-management-and-finance/03_project_management_core/) — project basics、组织结构、Talent Triangle、process groups
- [第4章 进度、WBS、沟通与风险](/notes/engineering-project-management-and-finance/04_schedule_wbs_risk_comms/) — WBS、CPM、communication、risk、conflict
- [第5章 财务与成本](/notes/engineering-project-management-and-finance/05_finance_and_costing/) — NPV/BCR/IRR、cash flow、break-even、make-or-buy、P&L
