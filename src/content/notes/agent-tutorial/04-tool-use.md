...
> 完整代码见 [`code/04-tool-use/basic_function_calling.py`](/agent-tutorial/code/04-tool-use/basic_function_calling.py)。
...
> 完整代码见 [`code/04-tool-use/multi_tool_agent.py`](/agent-tutorial/code/04-tool-use/multi_tool_agent.py)。
...
> 完整代码见 [`code/04-tool-use/error_handling.py`](/agent-tutorial/code/04-tool-use/error_handling.py)。
...
下一章：[Agent 循环 — 思考-行动-观察](/notes/tutorial/ai-agent/05-agent-loop/) — **全教程最关键的一章**。
