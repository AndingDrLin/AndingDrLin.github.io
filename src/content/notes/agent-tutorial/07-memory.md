...
> 完整代码见 [`code/07-memory/conversation_summary.py`](/agent-tutorial/code/07-memory/conversation_summary.py)。
...
> 完整代码见 [`code/07-memory/vector_memory.py`](/agent-tutorial/code/07-memory/vector_memory.py)。
...
> 完整代码见 [`code/07-memory/full_memory_system.py`](/agent-tutorial/code/07-memory/full_memory_system.py)。
...
下一章：[Multi-Agent 系统](/notes/tutorial/ai-agent/08-multi-agent/)。
