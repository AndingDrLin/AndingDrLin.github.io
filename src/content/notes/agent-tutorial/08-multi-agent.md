...
> 完整代码见 [`code/08-multi-agent/crewai_example.py`](/agent-tutorial/code/08-multi-agent/crewai_example.py)。
...
> 完整代码见 [`code/08-multi-agent/debate_agents.py`](/agent-tutorial/code/08-multi-agent/debate_agents.py)，其中实现了辩论式 Multi-Agent 系统。
...
下一章：[生产级 Agent 的关键问题](/notes/tutorial/ai-agent/09-production/)。
